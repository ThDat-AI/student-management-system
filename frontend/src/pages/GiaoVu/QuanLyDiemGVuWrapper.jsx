...
const QuanLyDiemGVuWrapper = () => {
  ...
  useEffect(() => {
    setPageTitle("Quản lý điểm - Giáo vụ");
  }, [setPageTitle]);
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: "Tạo và tải báo cáo điểm học sinh theo lớp và học kỳ.",
      icon: <FaFileExport />,
      color: "success",
      path: "/giaovu/quan-ly-diem/xuat-bao-cao",
    },
  ];
  ...
  return (
    <div className="dashboard-container">
      <Container fluid className="px-4 py-4">
        ...
        <div className="welcome-banner p-4 rounded-4 position-relative overflow-hidden mb-4">
          ...
          <div className="welcome-content d-flex align-items-center">
            ...
            <div>
              ...
              <p className="text-white-75 mb-0 banner-subtitle">Tổng hợp và xuất báo cáo kết quả học tập</p>
            </div>
          </div>
        </div>
        ...
        {/* Menu */}
        <div className="mb-5">
          <h5 className="fw-bold text-dark mb-3 border-start border-primary border-4 ps-2">Chức năng điểm</h5>
          <Row className="g-4">
...
export default QuanLyDiemGVuWrapper;
